...
export const siteConfig = {
  ...
  // Datele de contact. Sunt goale intentionat: nu le-am gasit nicaieri in
  // continutul importat si nu inventam un e-mail sau un telefon pe un site
  // de produse medicale. Pagina de contact afiseaza doar ce e completat aici.
  contact: {
    email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || "",
    phone: process.env.NEXT_PUBLIC_CONTACT_PHONE || "",
    schedule: process.env.NEXT_PUBLIC_CONTACT_SCHEDULE || "",
  },
  company: {
